...
label_direct = Label(window, bg = "black", fg = "white", text = "Direction : ")
label_direct.place(relx = 0.3, rely = 0.8, anchor = CENTER)

directs = ["Left", "Right", "Up", "Down"]
selectedval = StringVar()
dropdown = ttk.Combobox(window, values = directs, textvariable = selectedval)
...
open_btn = Button(window, text = "Open Image", bg = "Grey", fg = "white", font = ("Times New Roman", 15, "bold"), padx = 15, pady = 10, relief = SOLID, command = openImg)
open_btn.place(relx = 0.5, rely = 0.1, anchor = CENTER)

rotate_btn = Button(window, text = "Rotate Image", bg = "Grey", fg = "white", font = ("Times New Roman", 15, "bold"), padx = 15, pady = 10, relief = SOLID, command = rotateImg)
